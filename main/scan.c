...
#define EXAMPLE_ESP_WIFI_SSID      "Totalplay-Martinez"
#define EXAMPLE_ESP_WIFI_PASS      "Campeche"
...
void wifi_init_sta(char* ssid, char *password)
{
    ...
    ESP_LOGI(TAG, "red:%s,contraseña:%s", wifi_config.sta.ssid, wifi_config.sta.password);
            ...
            if (str_mem[index - 1] == 13)
            {
                ...
                if (stringLen >= 1)
                {
                    ...
                    if (!strcmp(arrayString[0], "-i") || (!strcmp(arrayString[0], "-I") && stringLen > 2))
                    {
                        ...
                        ESP_LOGI(TAG, "Conectar a %s %s", arrayString[1], arrayString[2]);
                        wifi_init_sta(arrayString[1], arrayString[2]);
                    }
...
void app_main(void)
{
    ...
    wifi_scan();
    xTaskCreate(echo_task, "uart_echo_task", ECHO_TASK_STACK_SIZE * 4, NULL, 10, NULL);
}
